  ...
  return (
    <div className="bg-info bg-opacity-50 border border-3 border-primary border-opacity-50 rounded-5 shadow-lg p-3 mx-1">
      <div className="position-relative d-flex justify-content-center align-items-center mb-1">
        ...
        {hasOrderChanges && (
          <button
            ...
            title={t("save")}
          >
            <img src={saveIcon} alt="save" className="icon pointer" />
          </button>
        )}
      </div>
      ...
      {items.length > 0 ? (
        <>
          ...
          >
            <Table bordered striped hover size="sm">
              ...
              <tfoot>
                <tr className="fw-bold">
                  <td colSpan="3" className="bg-warning bg-opacity-10">
                    {t("home:total")}
                  </td>
        ...
        <div>
          <p className="mt-3 fs-4 fw-bold">{t("home:noHomes")}</p>
        </div>
      )}
