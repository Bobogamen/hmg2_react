...
import ModalRepairNavigator from "./ModalRepairNavigator";
    ...
    <div className="repair-details">
      <div className="d-flex justify-content-center align-items-stretch gap-2 mb-3 mb-lg-4">
        ...
        <button
          ...
          aria-label={t("finance:repairNavigator.open")}
          title={t("finance:repairNavigator.open")}
          aria-haspopup="dialog"
        >
          <img src={repairIcon} className="medium-icon" alt="" />
        </button>
      </div>
      <ModalRepairNavigator
        show={showNavigator}
        handleClose={() => setShowNavigator(false)}
